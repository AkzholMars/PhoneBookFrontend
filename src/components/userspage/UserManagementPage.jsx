...
function UserManagementPage() {
  ...
  return (
    <div className="bg-gray-200  dark:bg-gray-800 items-center px-6 mx-auto md:bg-contain lg:py-0 ">
      <br />
      <h2 className="text-center text-2xl font-semibold whitespace-nowrap text-gray-800 dark:text-white">
        Панел администатора
      </h2>

      <div className="h-full relative overflow-x-auto shadow-md ">
        <button
          className="border
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-900 dark:text-gray-300">
          <thead className="text-xs uppercase dark:bg-gray-700 bg-gray-500 bg-gray-200 text-gray-100">
            <tr>
              <th scope="col" className="px-6 py-3 ">
                <div className="flex items-center">ID</div>
              </th>
              <th scope="col" className="px-6 py-3 ">
                <div className="flex items-center">ФИО</div>
              </th>
              <th scope="col" className="px-6 py-3 ">
              ...
              <th scope="col" className="px-6 py-3 ">
                <div className="flex items-center">Роль</div>
              </th>
              <th scope="col" className="px-6 py-3 ">
                <div className="flex items-center">Действия</div>
              </th>
            </tr>
          </thead>
          <tbody>
            {users.map((user) => (
              ...
              >
                ...
                <td className="px-3 py-1">{user.department}</td>
                <td className="px-3 py-1">{user.position}</td>
                <td className="px-3 py-1">{user.phone}</td>
                <td className="px-3 py-1">{user.role}</td>
                <td>
                  <div className="rof flex">
                    <Link to={`/update-user/${user.id}`}>
                      <button className="w-10 h-10 justify-center inline-flex items-center border rounded-lg border-green-500 text-green-500 hover:border-white hover:text-white hover:bg-green-600 focus:ring-green-900">
                        <svg
                    ...
                    <button
                      ...
                      className="w-10 h-10 justify-center inline-flex items-center border rounded-lg border-red-500 text-red-500 hover:border-white hover:text-white hover:bg-red-600 focus:ring-red-900"
                    >
                      <svg
                        className="w-5 h-5 fill-current"
                        fill="currentColor"
                    ...
                    <Link to={`/reset-password/${user.id}`}>
                      <button className="w-10 h-10 justify-center inline-flex items-center border rounded-lg border-blue-500 hover:border-white hover:text-white text-blue-500  hover:bg-blue-600 focus:ring-blue-900">
                        <svg
                          className="w-5 h-5 fill-current"
                          fill="currentColor"
                          xmlns="http://www.w3.org/2000/svg"
